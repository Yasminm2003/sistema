...
@endforeach
<h2 class="text-xl font-semibold mt-6 mb-4">Cadastrar Item por Departamento</h2>

<form wire:submit.prevent="cadastrarItem" class="space-y-4">
    <div>
        <label for="departamento_id" class="block font-medium">Departamento</label>
    ...
    <div>
        <label for="nome" class="block font-medium">Nome do Item</label>
